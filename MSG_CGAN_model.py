...
from MSG_CGAN_Generator import Generator
from MSG_CGAN_Discriminator import Discriminator
...
class MSG_CGAN:
    ...
    def train_step(self, images, categories):
        ...
        gen_categories = torch.randint(low = 0, high = self.Label_size, size = (self.Batch_size,))
    ...
    def train(self, num_epochs, dataloader, already_trained_epochs = 0, feedback_freq = 5, save_freq = 10):
        ...
        for epoch in tqdm(range(already_trained_epochs, num_epochs)):
            ...
            if epoch % save_freq == 0 or epoch == num_epochs -1:
                self.save_model(self.Generator, "MSG_CGAN_gen", epoch)
                self.save_model(self.Discriminator, "MSG_CGAN_disc", epoch)
